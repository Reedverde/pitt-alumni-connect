...
## Current-roster classification (2026-09-05, supersedes the exact-2026 rule)

- "Current" has one definition, the `current_people` view: a real stint in the newest roster year present in `stints` (currently **2027**), in any role — player, captain, coach or manager — minus anyone marked `is_current = false` in `current_status_overrides`. The earlier working-`@pitt.edu` branch was **removed on 2026-09-06** (Reed's confirmation); a deliverable Pitt address is contactability evidence only and never confers Current. `identities.verified_at` still means inbox authentication only. `board_people.is_current` and the organizer people/head splits (`admin.server.ts` `loadContext`) both read that view; no other place computes it.
- 2027 is the new roster category and appears on the board through the existing latest-stint placement (`person_board_placement`). No UI was added.
- 2026 is last season's history and is not trimmed to the new lists. 2027 rosters: MENS_A 24 players (the esnultimate.org 2025–26 season page minus its 5th Year/Grad section — Adam Ricci, Jake Sperry, Peter Kotz); MENS_B 31 players and coaches Ben Banyas, Will Litchholt, Tyler Weinberger, from captain Jared Kartschoke's 2026-09-05 roster.
- 2026 holds: MENS_A 24 players + coaches Nick Kaczmarek and Dylan Best; MENS_B 40 players (the nine earlier removals restored with their original ids) + coaches Ben and Will. Tyler Weinberger's briefly created 2026 coach stint was removed; he is a 2027 coach.
...
- Post-change 2026 totals: going 64 people / 79 heads (38 graduates / 53 heads, 26 current / 26 heads); maybe 37 (30 / 7); not this year 51 (45 / 6). Board shows 99 current of 454; 67 people qualify through a working pitt.edu address.
